...
const { uploadProductImages, deleteCloudinaryImage } = require('../utils/imageHandler');
...
exports.createProduct = asyncHandler(async (req, res) => {
  ...
  // Upload any base64 images to Cloudinary; existing URLs pass through as-is
  const images = await uploadProductImages(rawImages);
...
exports.updateProduct = asyncHandler(async (req, res) => {
  ...
  const rawImages = req.body.images || product.images;
...
exports.deleteProduct = asyncHandler(async (req, res) => {
  ...
  // Best-effort cleanup — doesn't block deletion if Cloudinary is slow/down
